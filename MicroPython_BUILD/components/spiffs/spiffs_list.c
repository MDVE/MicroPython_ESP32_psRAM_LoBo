...
int IRAM_ATTR spiffslist_get(struct spiffs_list *list, int index, void **item) {
...
int IRAM_ATTR spiffslist_first(struct spiffs_list *list) {
    int index;
    int res = -1;
...
int IRAM_ATTR spiffslist_next(struct spiffs_list *list, int index) {
    int res = -1;
    int iindex;
